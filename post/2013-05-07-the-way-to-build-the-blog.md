...
首先是建立一个极简的博客写作、更新至master、博客页面展示流程，参看[xx]的博客，总体感觉简洁、易于管理，对于样式可以自己创建，自由度大，但同时也是不能重用已有的类似wordpress的整体方案。缺点在于页面是使用JS动态生成，对于搜索引擎、页面静态化可能有影响。
...
所以，还是回归简单，先使用JS style的GitHub blog。